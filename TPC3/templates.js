exports.studentsListPage = function(slist, d){
    ...
    pagHTML += `
                ...
                <footer class="w3-container w3-blue">
                    <h5>Generated by Ana Sá Oliveira in ${d}</h5>
                </footer>
            </div>
        </body>
    </html>
        ...
        <body>
            <div class="w3-card-4">
                ...
                <footer class="w3-container w3-purple">
                    <h5>Generated by Ana Sá Oliveira in ${d} - [<a href="/">Return</a>]</h5>
                </footer>
...
exports.studentPage = function( aluno, d, deleted){
    var pagHTML = `
    <html>
    <head>
        <title>Student ${aluno.id}${deleted}</title>
        <meta charset="utf-8"/>
        <link rel="icon" href="favicon.png"/>
        <link rel="stylesheet" href="w3.css"/>
    </head>
    <body>
        <div class="w3-card-4">
            <header class="w3-container w3-teal">
                <h1>Student ${aluno.id}${deleted}</h1>
            </header>
    ...
    pagHTML +=     `</ul></div>
            <footer class="w3-container w3-teal">
                <address>Generated by Ana Sá Oliveira in ${d} - [<a href="/">Return</a>]</address>
            </footer>
        </div>
    </body>
    </html>
